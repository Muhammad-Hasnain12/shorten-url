        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex flex-col gap-3">
            <input
              ...
              className="w-full px-4 py-3 rounded-lg border border-border bg-input text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all text-base"
              disabled={isLoading}
            />
            <button
              type="submit"
              disabled={isLoading || !url.trim()}
              className="w-full px-6 py-3 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2 text-base"
            >
              {isLoading ? (
                <>
          ...
          <div className="space-y-3">
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                value={getShortUrl()}
                readOnly
                className="flex-1 px-4 py-3 rounded-lg border border-border bg-muted text-foreground font-mono text-sm break-all"
              />
              <button
                onClick={handleCopy}
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="flex-1 px-4 py-2 bg-accent text-accent-foreground rounded-lg hover:bg-accent/80 transition-all flex items-center justify-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="pt-4 border-t border-border">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <p className="text-foreground break-all mt-1" title={shortenedUrl.originalUrl}>
