            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-start justify-between gap-2">
                  <h3 className="font-semibold text-card-foreground text-sm sm:text-base break-all">
                    {url.originalUrl}
                  </h3>
                  <button
                ...
                <div className="space-y-2">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                    <span className="text-muted-foreground text-sm font-medium">Short URL:</span>
                    <code className="bg-muted px-3 py-2 rounded-lg text-primary font-mono text-sm break-all">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 pt-2 border-t border-border">
                ...
                <div className="flex flex-wrap gap-2 ml-auto">
                  ...
                  <a
                    ...
                    className="px-3 py-2 bg-primary text-primary-foreground rounded-lg text-sm font-medium hover:bg-primary/90 transition-colors flex items-center gap-1.5"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
